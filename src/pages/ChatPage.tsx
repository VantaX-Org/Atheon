  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br        from-amber-500/20 to-amber-400/20 flex items-center justify-center">
                  ...
                  {msg.role === 'assistant' && (
                    <div className="w-8 h-8 rounded-lg                  bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className={`max-w-2xl rounded-xl p-4 ${
                                      msg.role === 'user'
                                        ? 'bg-amber-500/100/10 border border-amber-500/20'
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder-gray-400 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500/30 transition-all"
                />
              </div>
