      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="          w-10 h-10 rounded-xl bg-[#2a7c8c]/10 flex items-center justify-center">
                      <ShieldCheck className="w-5 h-5 text-[#2a7c8c]"/>
          </div>
          <div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="                    w-10 h-10 rounded-lg bg-[#2a7c8c]/10 flex items-center justify-center">
                                          <Globe className="w-5 h-5 text-[#2a7c8c]"/>
                    </div>
                    <div>
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {roles.map((role) => {
              ...
              const color = role.name.toLowerCase().includes('admin') ? 'text-red-400' : role.name.toLowerCase().includes('exec') ? 'text-[#2a7c8c]' : role.name.toLowerCase().includes('manager') ? 'text-[#2a7c8c]' : 'text-[#2a7c8c]';
              return (
                <Card key={role.id}>
