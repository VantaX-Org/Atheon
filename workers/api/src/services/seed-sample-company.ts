...
export async function seedSampleCompany(db: D1Database) {
  ...
  const newAdapters = [
    ...
    { id: 'erp-sage-pastel', name: 'Sage Pastel Partner', system: 'Pastel', version: '2026.1', protocol: 'REST/SDK', status: 'available', operations: '["REST API v2","SDK Integration","DDE","ODBC"]', auth_methods: '["API Key","Session Auth","Username/Password"]' },
    { id: 'erp-sage-50', name: 'Sage 50cloud Pastel', system: 'Pastel', version: '2026', protocol: 'REST/SDK', status: 'available', operations: '["REST API v2","SDK","Pastel Connector","CSV Import"]', auth_methods: '["API Key","OAuth 2.0"]' },
    { id: 'erp-sage-intacct', name: 'Sage Intacct', system: 'Sage', version: 'R1 2026', protocol: 'REST/XML', status: 'available', operations: '["REST API","XML Gateway","Web Services","Smart Events"]', auth_methods: '["API Key","Session Auth","OAuth 2.0"]' },
    { id: 'erp-sage-300', name: 'Sage 300 (Accpac)', system: 'Sage', version: '2026', protocol: 'REST/SOAP', status: 'available', operations: '["REST API","SOAP","Views API","Macros"]', auth_methods: '["API Key","Session Auth"]' },
  ...
  const graphEntities = [
    ...
    { id: 'ge-protea-5', type: 'System', name: 'SAP S/4HANA', properties: '{"version":"2025 FPS01","type":"ERP","role":"primary"}', source: 'erp-adapter' },
    ...
    { id: 'ge-protea-8', type: 'System', name: 'Sage Pastel', properties: '{"version":"2026.1","type":"Legacy GL","role":"legacy"}', source: 'erp-adapter' },
    { id: 'ge-protea-9', type: 'System', name: 'Salesforce', properties: '{"version":"Spring 26","type":"CRM","role":"sales"}', source: 'erp-adapter' },
