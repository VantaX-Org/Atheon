...
const TENANT_TABLES = [
  ...
  'baseline_snapshots',
  'health_targets',
  // V2 Engine tables — Trial & Onboarding
  'trial_assessments',
  'onboarding_progress',
  ...
  // Sage ERP data tables
  'sage_goods_received',
  'sage_bank_transaction',
  'sage_purchase_order',
  'sage_stock_item',
  'sage_purchase_invoice',
  'sage_sales_invoice',
  'sage_nominal_ledger',
  'sage_supplier',
  'sage_customer',
  // Xero ERP data tables
  'xero_purchase_order',
  'xero_manual_journal',
  'xero_account',
  'xero_item',
